	...
	private void initialize() {
		...
		btnKreirajPopust.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (datePocetak.getDate() != null || dateKraj.getDate() != null
						|| txtIznosPopusta.getText().isEmpty() == false) {
					if (iac.provjeriDatume(datePocetak.getDate()) && iac.provjeriDatume(dateKraj.getDate())) {
						if (pc.provjeriIspravnost(datePocetak.getDate(), dateKraj.getDate())) {
							try {
								try {
									pc.dodajAkcijaPopust(datePocetak.getDate(), dateKraj.getDate(),
											textAreaOpis.getText(), Integer.parseInt(txtIznosPopusta.getText()));
								} catch (Exception e) {
									// JOptionPane.showMessageDialog(null,
									// e.getMessage(), "InfoBox",
					...
					messageBox.infoBox("Morate unijeti podatke u formu!", "Info Popust");
				}
			}
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
						...
						.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING).addComponent(lblOdaberiteDatum)
								.addComponent(lblIznosRaunaS).addComponent(lblDatumKraja).addComponent(lblOpis))
						.addGap(18)
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING).addComponent(textAreaOpis)
								.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
										.addComponent(datePocetak, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
												Short.MAX_VALUE)
										.addGroup(groupLayout.createSequentialGroup()
												.addComponent(txtIznosPopusta, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(ComponentPlacement.RELATED).addComponent(label))
										.addComponent(dateKraj, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
												Short.MAX_VALUE))))
						.addGroup(groupLayout.createSequentialGroup().addGap(72).addComponent(btnKreirajPopust,
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addGap(27)
						.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING).addComponent(lblOdaberiteDatum)
								.addComponent(datePocetak, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addGap(18)
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addComponent(dateKraj, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblDatumKraja))
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup().addGap(23).addComponent(lblOpis))
								.addGroup(groupLayout.createSequentialGroup().addGap(18).addComponent(textAreaOpis,
						...
						.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(label)
								.addComponent(lblIznosRaunaS).addComponent(txtIznosPopusta, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGap(39).addComponent(btnKreirajPopust).addContainerGap()));
